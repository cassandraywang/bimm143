...
Q1: How many observations are in this dataset?Number of patient smamples
...
Cluster 1 appears to be mostly malignant, and Cluster 2 appears to be
mostly benign.
...
Turn our groups into a factor and reorder the levels so cluster 2 (more
benign) comes first
...
Black cluster is Cluster 1 (benign), red is Cluster 2 (malignant). We
should prioritize Patient 2 for follow-up.
