...
The **length** column in count data will cause problems, so we need to
...
Remove genes that have 0 count values in all experiments (i.e. rows that
have 0 across all columns)
...
```
    ...
    ## Info: Working in directory /Users/cassandrawang/Documents/BIMM 143/bimm143/Class15
...
draw plots for all the top 5 upregulated
    pathways.
...
Output the list of significant genes at the 0.05 level as a plain text
file
